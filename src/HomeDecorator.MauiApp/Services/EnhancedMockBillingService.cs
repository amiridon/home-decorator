...
{
    /// <summary>
    /// Enhanced mock implementation of IBillingService for development
    /// This version uses the CreditLedgerService for more realistic behavior
    /// </summary>
    public class EnhancedMockBillingService : IBillingService
    {
        ...
        public EnhancedMockBillingService(ICreditLedgerService creditLedgerService)
        {
