// filepath: c:\Users\ImamuHunter\dev\home-decorator\src\HomeDecorator.Api\Endpoints\BillingEndpoints.cs
        ...
        public static void MapBillingEndpoints(this IEndpointRouteBuilder app)
        {
            ...
            app.MapGet("/api/billing/transactions", async (ICreditLedgerService creditLedgerService, int? count, HttpContext context) =>
            {
                try
                {
                    ...
                    var transactions = await creditLedgerService.GetTransactionHistoryAsync(userId, count ?? 20);
